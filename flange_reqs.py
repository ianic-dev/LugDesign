...
def transverse_load_ultimate(lugconfig: LugConfig, material: MaterialProperties) -> float:
    ...
    average_area = 6/(4/((lugconfig.flange_height/2 - lugconfig.pin_diameter * m.sin(m.radians(45)))*lugconfig.flange_thickness) + 2/((lugconfig.flange_height-lugconfig.pin_diameter)*lugconfig.flange_thickness/2))
    bearing_area = lugconfig.pin_diameter * lugconfig.flange_thickness
